...
export const CardSvg = forwardRef<SVGSVGElement, CardSvgProps>(({ data, config, labels, noDescriptionText }, ref) => {
  ...
  const descriptionText = config.text.customDescription || data.description || noDescriptionText;
